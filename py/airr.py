...
class AirlineManagementSystem:
    ...
    def create_flight_tab(self):
        ...
        style = ttk.Style()
        style.configure("Flight.TFrame", background="#F0FFFF")  # Define a new style with the desired background color
        flight_tab.config(style="Flight.TFrame")
    
        ttk.Label(flight_tab, background="#F0FFFF",text="Origin:").grid(row=0, column=0, padx=10, pady=5, sticky="w")
        self.origin_entry = ttk.Entry(flight_tab)
        self.origin_entry.grid(row=0, column=1, padx=10, pady=5)

        ttk.Label(flight_tab, background="#F0FFFF",text="Destination:").grid(row=1, column=0, padx=10, pady=5, sticky="w")
        self.destination_entry = ttk.Entry(flight_tab)
        self.destination_entry.grid(row=1, column=1, padx=10, pady=5)

        ttk.Label(flight_tab, background="#F0FFFF",text="Departure Time:").grid(row=2, column=0, padx=10, pady=5, sticky="w")
        self.departure_entry = ttk.Entry(flight_tab)
        self.departure_entry.grid(row=2, column=1, padx=10, pady=5)

        ttk.Label(flight_tab,background="#F0FFFF", text="Arrival Time:").grid(row=3, column=0, padx=10, pady=5, sticky="w")
        self.arrival_entry = ttk.Entry(flight_tab)
        self.arrival_entry.grid(row=3, column=1, padx=10, pady=5)

        ttk.Label(flight_tab, background="#F0FFFF",text="Flight ID:").grid(row=4, column=0, padx=10, pady=5, sticky="w")
        ...
        self.flight_info_text = tk.Text(flight_tab, background='#F0F0F0',height=20, width=110,borderwidth=2, relief="groove")
    ...
    def create_passenger_tab(self):
        ...
        style = ttk.Style()
        style.configure("Flight.TFrame", background="#F0FFFF")  # Define a new style with the desired background color
        passenger_tab.config(style="Flight.TFrame")
    

        ttk.Label(passenger_tab, background="#F0FFFF",text="Name:").grid(row=0, column=0, padx=10, pady=5, sticky="w")
        self.name_entry = ttk.Entry(passenger_tab)
        self.name_entry.grid(row=0, column=1, padx=10, pady=5)

        ttk.Label(passenger_tab, background="#F0FFFF",text="Email:").grid(row=1, column=0, padx=10, pady=5, sticky="w")
        self.email_entry = ttk.Entry(passenger_tab)
        self.email_entry.grid(row=1, column=1, padx=10, pady=5)

        ttk.Label(passenger_tab, background="#F0FFFF",text="Phone:").grid(row=2, column=0, padx=10, pady=5, sticky="w")
        self.phone_entry = ttk.Entry(passenger_tab)
        self.phone_entry.grid(row=2, column=1, padx=10, pady=5)

        ttk.Label(passenger_tab, background="#F0FFFF",text="Passenger ID:").grid(row=3, column=0, padx=10, pady=5, sticky="w")
        ...
        self.passenger_info_text = tk.Text(passenger_tab,background='#F0F0F0', height=20, width=90)
    ...
    def create_ticket_tab(self):
        ...
        style = ttk.Style()
        style.configure("Flight.TFrame", background="#F0FFFF")  # Define a new style with the desired background color
        ticket_tab.config(style="Flight.TFrame")
    

        ttk.Label(ticket_tab, background="#F0FFFF",text="Passenger ID:").grid(row=0, column=0, padx=10, pady=5, sticky="w")
        self.ticket_passenger_id_entry = ttk.Entry(ticket_tab)
        self.ticket_passenger_id_entry.grid(row=0, column=1, padx=10, pady=5)

        ttk.Label(ticket_tab,background="#F0FFFF", text="Flight ID:").grid(row=1, column=0, padx=10, pady=5, sticky="w")
        self.ticket_flight_id_entry = ttk.Entry(ticket_tab)
        self.ticket_flight_id_entry.grid(row=1, column=1, padx=10, pady=5)

        ttk.Label(ticket_tab, background="#F0FFFF",text="Seat Number:").grid(row=2, column=0, padx=10, pady=5, sticky="w")
        self.seat_number_entry = ttk.Entry(ticket_tab)
        self.seat_number_entry.grid(row=2, column=1, padx=10, pady=5)

        ttk.Label(ticket_tab, background="#F0FFFF",text="Price:").grid(row=3, column=0, padx=10, pady=5, sticky="w")
        ...
        self.ticket_info_text = tk.Text(ticket_tab, background='#F0F0F0',height=20, width=90)
    ...
    def create_airports_tab(self):
        ...
        style = ttk.Style()
        style.configure("Flight.TFrame", background="#F0FFFF")  # Define a new style with the desired background color
        airport_tab.config(style="Flight.TFrame")

        # Entry fields
        ttk.Label(airport_tab,background="#F0FFFF", text="AirportID:").grid(row=0, column=0, padx=10, pady=5, sticky="w")
        self.airport_name_entry = ttk.Entry(airport_tab)
        self.airport_name_entry.grid(row=0,column=1,padx=10, pady=5)

        ttk.Label(airport_tab,background="#F0FFFF", text="Name:").grid(row=1,padx=10, pady=5, sticky="w")
        self.airport_name_entry = ttk.Entry(airport_tab)
        self.airport_name_entry.grid(row=1,column=1,padx=10, pady=5)

        ttk.Label(airport_tab,background="#F0FFFF", text="Location:").grid(row=2,padx=10, pady=5, sticky="w")
        self.airport_location_entry = ttk.Entry(airport_tab)
        self.airport_location_entry.grid(row=2,column=1,padx=10, pady=5)
        ...
        self.airport_info_text = tk.Text(airport_tab, background='#F0F0F0',height=20, width=95)
    ...
    def create_employee_tab(self):
        ...
        style = ttk.Style()
        style.configure("Flight.TFrame", background="#F0FFFF")  # Define a new style with the desired background color
        employee_tab.config(style="Flight.TFrame")

        ttk.Label(employee_tab,background="#F0FFFF", text="Name:").grid(row=0, column=0, padx=10, pady=5, sticky="w")
        self.employee_name_entry = ttk.Entry(employee_tab)
        self.employee_name_entry.grid(row=0, column=1, padx=10, pady=5)

        ttk.Label(employee_tab,background="#F0FFFF", text="Position:").grid(row=1, column=0, padx=10, pady=5, sticky="w")
        self.employee_position_entry = ttk.Entry(employee_tab)
        self.employee_position_entry.grid(row=1, column=1, padx=10, pady=5)

        ttk.Label(employee_tab,background="#F0FFFF", text="Employee ID:").grid(row=2, column=0, padx=10, pady=5, sticky="w")
        ...
        self.employee_info_text = tk.Text(employee_tab,background='#F0F0F0', height=20, width=90)
    ...
    def create_aircraft_tab(self):
        ...
        style = ttk.Style()
        style.configure("Flight.TFrame", background="#F0FFFF")  # Define a new style with the desired background color
        aircraft_tab.config(style="Flight.TFrame")

        ttk.Label(aircraft_tab,background="#F0FFFF", text="Type:").grid(row=0, column=0, padx=10, pady=5, sticky="w")
        self.aircraft_type_entry = ttk.Entry(aircraft_tab)
        self.aircraft_type_entry.grid(row=0, column=1, padx=10, pady=5)

        ttk.Label(aircraft_tab, background="#F0FFFF",text="Capacity:").grid(row=1, column=0, padx=10, pady=5, sticky="w")
        self.capacity_entry = ttk.Entry(aircraft_tab)
        self.capacity_entry.grid(row=1, column=1, padx=10, pady=5)

        ttk.Label(aircraft_tab,background="#F0FFFF", text="Aircraft ID:").grid(row=2, column=0, padx=10, pady=5, sticky="w")
        ...
        self.aircraft_info_text = tk.Text(aircraft_tab, background='#F0F0F0',height=20, width=90)
